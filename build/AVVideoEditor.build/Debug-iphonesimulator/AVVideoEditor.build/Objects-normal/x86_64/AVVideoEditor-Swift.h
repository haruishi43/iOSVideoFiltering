...
SWIFT_MODULE_NAMESPACE_PUSH("AVVideoEditor")
@class NSCoder;

SWIFT_CLASS("_TtC13AVVideoEditor12AVPlayerView")
...
SWIFT_CLASS("_TtC13AVVideoEditor11AppDelegate")
...
SWIFT_CLASS("_TtC13AVVideoEditor10FilterCell")
...
SWIFT_CLASS("_TtC13AVVideoEditor29FilterSelectionViewController")
...
SWIFT_CLASS("_TtC13AVVideoEditor14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(AVVideoEditor)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@interface ViewController (SWIFT_EXTENSION(AVVideoEditor)) <UIPopoverPresentationControllerDelegate>
...
@interface ViewController (SWIFT_EXTENSION(AVVideoEditor))
